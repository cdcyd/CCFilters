...
class CIDivideBlendMode: BaseFilter {
    ...
    private func setupDescription() {
        self.descView.text = """
        滤镜：CIDivideBlendMode
        系统：iOS8.0
        简介：Divides the background image sample color from the source image sample color.
        """
    }
