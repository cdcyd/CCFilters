...
class CIHoleDistortion: BaseFilter {

    private var imageView: UIImageView!
    private let image = UIImage("ImageR")
    private let name = "CIHoleDistortion"
    ...
    private func setupViews() {
        let slider = SliderView(title: "Radius", min: 0.01, max: 1000, value: 50.0)
    ...
    private func setupDescription() {
        ...
        滤镜：CIHoleDistortion
        系统：iOS6.0
        简介：Creates a circular area that pushes the image pixels outward, distorting those pixels closest to the circle the most.
        """
    }
...
extension CIHoleDistortion: SliderViewDelegate {
