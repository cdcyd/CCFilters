...
class CIPinLightBlendMode: BaseFilter {
    ...
    private func setupDescription() {
        self.descView.text = """
        滤镜：CIPinLightBlendMode
        系统：iOS8.0
        简介：Conditionally replaces background image samples with source image samples depending on the brightness of the source image samples.
        """
    }
