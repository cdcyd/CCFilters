...
class CISoftLightBlendMode: BaseFilter {
    ...
    private func setupDescription() {
        self.descView.text = """
        滤镜：CISoftLightBlendMode
        系统：iOS6.0
        简介：Either darkens or lightens colors, depending on the input image sample color.
